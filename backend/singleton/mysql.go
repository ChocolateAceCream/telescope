...
type Mysql struct {
	...
	DbName       string `mapstructure:"db-name" json:"db_name" yaml:"db-name"`
	...
	LogMode      string `mapstructure:"log-mode" json:"log_mode" yaml:"log-mode"` // turn on global gorm log
	LogZap       bool   `mapstructure:"log-zap" json:"log_zap" yaml:"log-zap"`    // use zap to log
	CharSet      string `mapstructure:"charset" json:"charset" yaml:"charset"`
	ParseTime    string `mapstructure:"parseTime" json:"parse_time" yaml:"parseTime"` // to parse time based on locale
